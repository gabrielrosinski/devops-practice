...
echo ""
echo -e "${BLUE}💡 IMPORTANT: Manually import the Grafana dashboard${NC}"
echo -e "${YELLOW}To see alerts and application monitoring:${NC}"
echo "  1. Open Grafana at http://localhost:3000"
echo "  2. Go to Dashboards → Import"
echo "  3. Upload the grafana-dashboard.json file from this directory"
echo "  4. The dashboard includes application alerts, restart monitoring, and metrics"
echo ""
